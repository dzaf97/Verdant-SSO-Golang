...
func ResponseJSON(w http.ResponseWriter, flag bool, httpErrorCode int, payload interface{}) {
...
func CallApi(r *http.Request) (*simplejson.Json, error) {
	...
	if resp.StatusCode != 200 {
		...
		return nil, errors.New("Api cannot request")
	}
